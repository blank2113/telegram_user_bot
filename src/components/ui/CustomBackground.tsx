  ...
  return (
    <div
      className={
        ...
        "border-t border-t-[1px] border-t-[#24E6F3CC] " +
        "backdrop-blur-md py-2 px-3 rounded-[12px] max-w-full w-full min-h-[100px] flex items-center flex-row justify-end gap-5"
      }>
